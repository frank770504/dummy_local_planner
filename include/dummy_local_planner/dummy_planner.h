#ifndef DUMMY_LOCAL_PLANNER_DUMMY_PLANNER_H_
#define DUMMY_LOCAL_PLANNER_DUMMY_PLANNER_H_
...
namespace dummy_local_planner {
  ...
  class DummyPlanner {
    public:
       ...
       */
      DummyPlanner(std::string name, base_local_planner::LocalPlannerUtil *planner_util);

      /**
       * @brief  Destructor for the planner
       */
      ~DummyPlanner() {if(traj_cloud_) delete traj_cloud_;}

      /**
       * @brief Reconfigures the trajectory planner
       */
      void reconfigure(DummyPlannerConfig &cfg);
    ...
    private:
      ...
      double sim_period_;///< @brief The number of seconds to use to compute max/min vels for dummy
      ...
      double valid_trajectory_ratio_;
